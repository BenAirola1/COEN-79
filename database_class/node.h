...
//
//   void list_remove(node*& prev)
//      Precondition: prev is not NULL nor the tail pointer of a linked list
//      Postcondition: The node immediately following prev has been removed from
//      the linked list and returned to the heap.
//
